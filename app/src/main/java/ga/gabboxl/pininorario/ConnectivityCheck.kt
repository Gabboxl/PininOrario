...
class ConnectivityCheck(context: Context) : LiveData<Boolean>() {
    ...
    private fun checkInternet() {
        ...
        val network = connectivityManager.activeNetworkInfo //uso activeNetworkInfo al posto di activeNetwork perche la api minima per cui buildo e minore di 23
        if (network == null) {
            postValue(false)
        }
